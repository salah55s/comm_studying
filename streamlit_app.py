...
if api_key:
    ...
    def generate_response(reference_text, user_input, image_url=None, subject="Logic design"):
        ...
        if subject == "Logic design":
            ...
            You must write the full truth table, equations, full needed answers, and all the steps needed to solve the questions. Focus on each detail and use a step-by-step and thoughts to get the correct and most accurate answer. 

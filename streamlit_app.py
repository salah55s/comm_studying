...
def generate_response(reference_text, user_input, image_url=None):
    ...
    with st.spinner("Thinking..."):
        res = model.invoke([
            SystemMessage(content=f"""You are a student helper AI, called ECE HELPER, helping answer and study questions about the chosen subject. Respond with elaboration like a professor, and try to use the information from the documents provided, but never say that you used it.  

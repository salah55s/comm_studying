...
if api_key:
    ...
    model_1 = ChatGoogleGenerativeAI(model="gemini-1.5-flash-latest", convert_system_message_to_human=True,safety_settings={HarmCategory.HARM_CATEGORY_DANGEROUS_CONTENT: HarmBlockThreshold.BLOCK_NONE,
...
/n/n:references :/n{reference_text}""")]
    ...
    def rag_with_text(user_ask_text, vectorstore):
        ...
        docs = vectorstore.similarity_search(user_ask_text, k=2) 
        return docs
